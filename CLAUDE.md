...
- Catálogo vigente: Pack Mini Core · Spark · Orion IA Agent · Core Spark Web · Core Orion · WhiteMoon 360 · Core RAG, más los productos sueltos Auditoría GEO IA y Calculadora ITP Pro. Pack Ads está RETIRADO: WhiteMoon no gestiona publicidad (Meta Ads) ni como pack ni como servicio; /pack-ads/ redirige a /precios/. Scale y Elite están RETIRADOS (no mencionar como productos; /scale/ y /elite/ redirigen a /precios/). Orion IA Calls también retirado (/orion-calls/ redirige a /orion-agent/).
