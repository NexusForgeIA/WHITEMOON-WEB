...
(function(){
  ...
  function buildWidget(cfg){
    ...
    var NAME_INTERES_WORDS = [
      'me interesa','interesa','quiero','si quiero','sí quiero',
      'adelante','vamos','empezamos','me apunto',
      'quiero saber mas','quiero saber más',
      'si','sí','claro','por supuesto','dale'
    ];
    function looksLikeInteres(text){
